...
static void buttons_init(void)
{
    ...
    static app_button_cfg_t buttons[] =
    {
        ...
        {CLEAR_NEW_ALERT_BUTTON_PIN,    false, BUTTON_PULL, button_event_handler},
        {CLEAR_UNREAD_ALERT_BUTTON_PIN, false, BUTTON_PULL, button_event_handler},
        {NOTIFY_ALL_ALERTS_BUTTON_PIN,  false, BUTTON_PULL, button_event_handler}
    };
